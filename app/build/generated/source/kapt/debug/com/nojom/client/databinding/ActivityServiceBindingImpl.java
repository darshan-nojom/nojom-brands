...
public class ActivityServiceBindingImpl extends ActivityServiceBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.lout_search, 2);
        sViewsWithIds.put(R.id.btn_filter, 3);
        sViewsWithIds.put(R.id.lout_best, 4);
        sViewsWithIds.put(R.id.rv_bestInf, 5);
        sViewsWithIds.put(R.id.tv_best_view, 6);
        sViewsWithIds.put(R.id.viewBestAll, 7);
    }
    // views
    @NonNull
