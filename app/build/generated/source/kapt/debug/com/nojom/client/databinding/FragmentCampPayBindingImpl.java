...
public class FragmentCampPayBindingImpl extends FragmentCampPayBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.txt2, 14);
        sViewsWithIds.put(R.id.txt3, 15);
        sViewsWithIds.put(R.id.txt4, 16);
        sViewsWithIds.put(R.id.rel_release, 17);
        sViewsWithIds.put(R.id.btn_release, 18);
        sViewsWithIds.put(R.id.progress_bar_signup, 19);
        sViewsWithIds.put(R.id.txt5, 20);
    }
    // views
    @NonNull
