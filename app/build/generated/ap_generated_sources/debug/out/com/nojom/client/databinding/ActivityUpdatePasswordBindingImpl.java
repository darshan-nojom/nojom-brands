...
public class ActivityUpdatePasswordBindingImpl extends ActivityUpdatePasswordBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.et_old_password, 3);
        sViewsWithIds.put(R.id.et_new_password, 4);
        sViewsWithIds.put(R.id.et_confirm_password, 5);
        sViewsWithIds.put(R.id.tv_save, 6);
        sViewsWithIds.put(R.id.progress_bar_signup, 7);
        sViewsWithIds.put(R.id.txt_forgot_password, 8);
        sViewsWithIds.put(R.id.rl_support_chat, 9);
    }
    // views
    @NonNull
    ...
    public ActivityUpdatePasswordBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 10, sIncludes, sViewsWithIds));
    }
    private ActivityUpdatePasswordBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
