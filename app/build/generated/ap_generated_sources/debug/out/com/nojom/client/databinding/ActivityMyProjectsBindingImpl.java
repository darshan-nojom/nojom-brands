...
public class ActivityMyProjectsBindingImpl extends ActivityMyProjectsBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.segmentedGroupTab, 2);
        sViewsWithIds.put(R.id.tab_workInProgress, 3);
        sViewsWithIds.put(R.id.tab_pastProjects, 4);
    ...
    public ActivityMyProjectsBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 11, sIncludes, sViewsWithIds));
    }
    private ActivityMyProjectsBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
