...
public class ActivityHomeBindingImpl extends ActivityHomeBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.txt_hire_lawyer_lbl, 1);
        sViewsWithIds.put(R.id.rel_header_login, 2);
        sViewsWithIds.put(R.id.img_profile, 3);
        sViewsWithIds.put(R.id.img_logo, 4);
        sViewsWithIds.put(R.id.lout_search, 5);
        sViewsWithIds.put(R.id.btn_filter, 6);
        sViewsWithIds.put(R.id.lout_best, 7);
        sViewsWithIds.put(R.id.rv_bestInf, 8);
        sViewsWithIds.put(R.id.tv_best_view, 9);
        sViewsWithIds.put(R.id.viewBestAll, 10);
    }
    // views
    @NonNull
