...
public class ActivityGetDiscountBindingImpl extends ActivityGetDiscountBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.tab_earnMoney, 4);
        sViewsWithIds.put(R.id.tab_myLevel, 5);
        sViewsWithIds.put(R.id.tab_Easy, 6);
        sViewsWithIds.put(R.id.tab_win, 7);
    ...
    public ActivityGetDiscountBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 9, sIncludes, sViewsWithIds));
    }
    private ActivityGetDiscountBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
