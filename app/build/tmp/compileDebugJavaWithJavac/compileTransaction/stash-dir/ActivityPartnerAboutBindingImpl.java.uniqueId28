...
public class ActivityPartnerAboutBindingImpl extends ActivityPartnerAboutBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.lin_questions, 2);
        sViewsWithIds.put(R.id.tv_save, 3);
    ...
    public ActivityPartnerAboutBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 5, sIncludes, sViewsWithIds));
    }
    private ActivityPartnerAboutBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
