...
public class FragmentBalanceDepositBindingImpl extends FragmentBalanceDepositBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.rv_income, 5);
        sViewsWithIds.put(R.id.tv_deposit_money, 6);
        sViewsWithIds.put(R.id.shimmer_layout, 7);
    }
    // views
    @NonNull
    ...
    public FragmentBalanceDepositBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 8, sIncludes, sViewsWithIds));
    }
    private FragmentBalanceDepositBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
