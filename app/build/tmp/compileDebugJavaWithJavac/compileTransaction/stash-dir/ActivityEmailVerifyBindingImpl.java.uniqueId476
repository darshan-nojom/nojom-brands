...
public class ActivityEmailVerifyBindingImpl extends ActivityEmailVerifyBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.ll_otp, 3);
        sViewsWithIds.put(R.id.et_otp, 4);
    ...
    public ActivityEmailVerifyBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 6, sIncludes, sViewsWithIds));
    }
    private ActivityEmailVerifyBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
