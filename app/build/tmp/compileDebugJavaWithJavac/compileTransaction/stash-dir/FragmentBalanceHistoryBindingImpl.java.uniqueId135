...
public class FragmentBalanceHistoryBindingImpl extends FragmentBalanceHistoryBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.rv_withdraw, 4);
        sViewsWithIds.put(R.id.shimmer_layout, 5);
    }
    // views
    @NonNull
    ...
    public FragmentBalanceHistoryBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 6, sIncludes, sViewsWithIds));
    }
    private FragmentBalanceHistoryBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
