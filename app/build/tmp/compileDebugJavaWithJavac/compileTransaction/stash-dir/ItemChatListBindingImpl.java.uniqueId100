...
public class ItemChatListBindingImpl extends ItemChatListBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.img_online, 2);
        sViewsWithIds.put(R.id.tv_receiver_name, 3);
        sViewsWithIds.put(R.id.tv_last_message, 4);
    ...
    public ItemChatListBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 6, sIncludes, sViewsWithIds));
    }
    private ItemChatListBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
