...
public class ItemCampaignStarsBindingImpl extends ItemCampaignStarsBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.txt_percent, 8);
    }
    // views
    // variables
    // values
    ...
    public ItemCampaignStarsBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 9, sIncludes, sViewsWithIds));
    }
    private ItemCampaignStarsBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
