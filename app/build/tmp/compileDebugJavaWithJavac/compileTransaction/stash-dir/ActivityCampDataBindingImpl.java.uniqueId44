...
public class ActivityCampDataBindingImpl extends ActivityCampDataBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.default_text_input_layout_dat, 13);
        sViewsWithIds.put(R.id.et_name, 14);
        sViewsWithIds.put(R.id.default_text_input_layout_tim, 15);
        sViewsWithIds.put(R.id.et_time, 16);
        sViewsWithIds.put(R.id.default_text_input_layout_brief, 17);
        sViewsWithIds.put(R.id.et_brief, 18);
        sViewsWithIds.put(R.id.tv_attach_file, 19);
        sViewsWithIds.put(R.id.tv_attach_file_desc, 20);
        sViewsWithIds.put(R.id.lin_file, 21);
        sViewsWithIds.put(R.id.imgFile, 22);
        sViewsWithIds.put(R.id.fileName, 23);
        sViewsWithIds.put(R.id.fileDate, 24);
        sViewsWithIds.put(R.id.imgDelete, 25);
        sViewsWithIds.put(R.id.rel_btn, 26);
        sViewsWithIds.put(R.id.btn_continue_price, 27);
    ...
    private ActivityCampDataBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 0
            ...
            , (android.button.CustomButton) bindings[27]
            ...
            , (fr.castorflex.android.circularprogressbar.CircularProgressBar) bindings[28]
