...
public class DataBinderMapperImpl extends DataBinderMapper {
  ...
  private static final int LAYOUT_ACTIVITYDEPOSIT = 25;

  private static final int LAYOUT_ACTIVITYDEPOSITFUNDSCOPY = 26;

  private static final int LAYOUT_ACTIVITYEDITPAYPAL = 27;

  private static final int LAYOUT_ACTIVITYEMAILVERIFY = 28;

  private static final int LAYOUT_ACTIVITYEXPERTFILTER = 29;

  private static final int LAYOUT_ACTIVITYEXPERTGIGFILTER = 30;

  private static final int LAYOUT_ACTIVITYFINDEXPERT = 31;

  private static final int LAYOUT_ACTIVITYFREELANCERPROFILE = 32;

  private static final int LAYOUT_ACTIVITYGETDISCOUNT = 33;

  private static final int LAYOUT_ACTIVITYGIGDETAILS = 34;

  private static final int LAYOUT_ACTIVITYGIGEXTRAS = 35;

  private static final int LAYOUT_ACTIVITYHIRE = 36;

  private static final int LAYOUT_ACTIVITYHOME = 37;

  private static final int LAYOUT_ACTIVITYHOWITWORKS = 38;

  private static final int LAYOUT_ACTIVITYINFSERVICE = 39;

  private static final int LAYOUT_ACTIVITYINFLPROFILEALL = 40;

  private static final int LAYOUT_ACTIVITYINFLUENCERFILTER = 41;

  private static final int LAYOUT_ACTIVITYINFLUENCERPROFILE = 42;

  private static final int LAYOUT_ACTIVITYINFLUENCERPROFILECOPY = 43;

  private static final int LAYOUT_ACTIVITYJOBPOSTTITLE = 44;

  private static final int LAYOUT_ACTIVITYLAWYERHOME = 45;

  private static final int LAYOUT_ACTIVITYLAWYERHOMENEW = 46;

  private static final int LAYOUT_ACTIVITYLOGINSIGNUP = 47;

  private static final int LAYOUT_ACTIVITYMAIN = 48;

  private static final int LAYOUT_ACTIVITYMAINTAINANCE = 49;

  private static final int LAYOUT_ACTIVITYMILESTONE = 50;

  private static final int LAYOUT_ACTIVITYMYCAMPAIGN = 51;

  private static final int LAYOUT_ACTIVITYMYINVOICES = 52;

  private static final int LAYOUT_ACTIVITYMYPROFILE = 53;

  private static final int LAYOUT_ACTIVITYMYPROJECTS = 54;

  private static final int LAYOUT_ACTIVITYNEWPOLICY = 55;

  private static final int LAYOUT_ACTIVITYNOTIFICATION = 56;

  private static final int LAYOUT_ACTIVITYOFFERSUMMARY = 57;

  private static final int LAYOUT_ACTIVITYOFFERTITLE = 58;

  private static final int LAYOUT_ACTIVITYOTP = 59;

  private static final int LAYOUT_ACTIVITYOTPVERIFY = 60;

  private static final int LAYOUT_ACTIVITYPARTNERABOUT = 61;

  private static final int LAYOUT_ACTIVITYPARTNERPROFILE = 62;

  private static final int LAYOUT_ACTIVITYPARTNERWITHUS = 63;

  private static final int LAYOUT_ACTIVITYPAYMENT = 64;

  private static final int LAYOUT_ACTIVITYPAYMENTNEW = 65;

  private static final int LAYOUT_ACTIVITYPHONEVERIFY = 66;

  private static final int LAYOUT_ACTIVITYPOSTJOB = 67;

  private static final int LAYOUT_ACTIVITYPOSTJOBNEW = 68;

  private static final int LAYOUT_ACTIVITYPRIVATEINFO = 69;

  private static final int LAYOUT_ACTIVITYPROFILEINFO = 70;

  private static final int LAYOUT_ACTIVITYPROFILESTARS = 71;

  private static final int LAYOUT_ACTIVITYPROJECTDETAILS = 72;

  private static final int LAYOUT_ACTIVITYPUBLICPROFILE = 73;

  private static final int LAYOUT_ACTIVITYSEARCHTAGS = 74;

  private static final int LAYOUT_ACTIVITYSELECTACCOUNT = 75;

  private static final int LAYOUT_ACTIVITYSELECTEXPERTISE = 76;

  private static final int LAYOUT_ACTIVITYSELECTFREELANCER = 77;

  private static final int LAYOUT_ACTIVITYSELLERSSERVICE = 78;

  private static final int LAYOUT_ACTIVITYSERVICESELLERSSEARCH = 79;

  private static final int LAYOUT_ACTIVITYSERVICES = 80;

  private static final int LAYOUT_ACTIVITYSHAREDISCOUNT = 81;

  private static final int LAYOUT_ACTIVITYSPLASH = 82;

  private static final int LAYOUT_ACTIVITYUPDATELOCATION = 83;

  private static final int LAYOUT_ACTIVITYUPDATEPASSWORD = 84;

  private static final int LAYOUT_ACTIVITYUSERNAME = 85;

  private static final int LAYOUT_ACTIVITYVERIFICATION = 86;

  private static final int LAYOUT_ACTIVITYVERIFYPAYMENT = 87;

  private static final int LAYOUT_ACTIVITYVIEWALLGIG = 88;

  private static final int LAYOUT_ACTIVITYWALLET = 89;

  private static final int LAYOUT_ACTIVITYWALLETADDBALANCE = 90;

  private static final int LAYOUT_ACTIVITYWEBVIEW = 91;

  private static final int LAYOUT_ACTIVITYWHATWEDO = 92;

  private static final int LAYOUT_ACTIVITYWITHDRAWMONEY = 93;

  private static final int LAYOUT_CHATMOREOPTIONS = 94;

  private static final int LAYOUT_CHIP = 95;

  private static final int LAYOUT_CONTENTADDCARD = 96;

  private static final int LAYOUT_CONTENTCARDLIST = 97;

  private static final int LAYOUT_CUSTOMDIALOG = 98;

  private static final int LAYOUT_CUSTOMPARTNERABOUTVIEW = 99;

  private static final int LAYOUT_CUSTOMPARTNERTEXTVIEW = 100;

  private static final int LAYOUT_CUSTOMTOAST = 101;

  private static final int LAYOUT_DIALOGADDCONTACT = 102;

  private static final int LAYOUT_DIALOGBALANCEDEPOSIT = 103;

  private static final int LAYOUT_DIALOGBANKTRANSFERDONE = 104;

  private static final int LAYOUT_DIALOGCAMERADOCUMENTSELECT = 105;

  private static final int LAYOUT_DIALOGCANCELFREELANCER = 106;

  private static final int LAYOUT_DIALOGCHATNOW = 107;

  private static final int LAYOUT_DIALOGCHATSETTING = 108;

  private static final int LAYOUT_DIALOGCHOOSEPLATFORM = 109;

  private static final int LAYOUT_DIALOGCLOSEPROJECT = 110;

  private static final int LAYOUT_DIALOGCURRENCY = 111;

  private static final int LAYOUT_DIALOGCUSTOMPRICE = 112;

  private static final int LAYOUT_DIALOGCUSTOMPRICEOPTION = 113;

  private static final int LAYOUT_DIALOGDELETEACCOUNT = 114;

  private static final int LAYOUT_DIALOGDELETEPROJECT = 115;

  private static final int LAYOUT_DIALOGDEPOSIT = 116;

  private static final int LAYOUT_DIALOGDEPOSITNOTES = 117;

  private static final int LAYOUT_DIALOGEMAILVERIFICATION = 118;

  private static final int LAYOUT_DIALOGENTERCVV = 119;

  private static final int LAYOUT_DIALOGFEEDBACK = 120;

  private static final int LAYOUT_DIALOGFILEOPEN = 121;

  private static final int LAYOUT_DIALOGFILEOPTIONMENU = 122;

  private static final int LAYOUT_DIALOGFORGOTPASSWORD = 123;

  private static final int LAYOUT_DIALOGFREETRIAL = 124;

  private static final int LAYOUT_DIALOGITEMSELECTBLACK = 125;

  private static final int LAYOUT_DIALOGLANGUAGE = 126;

  private static final int LAYOUT_DIALOGLOCATIONDISCLOSURE = 127;

  private static final int LAYOUT_DIALOGLOCATIONSKILL = 128;

  private static final int LAYOUT_DIALOGLOGINNEW = 129;

  private static final int LAYOUT_DIALOGLOGINSIGNUP = 130;

  private static final int LAYOUT_DIALOGLOGOUT = 131;

  private static final int LAYOUT_DIALOGMYPROFILEDETAIL = 132;

  private static final int LAYOUT_DIALOGNOINTERNET = 133;

  private static final int LAYOUT_DIALOGOPENWEBSITE = 134;

  private static final int LAYOUT_DIALOGPAYDONE = 135;

  private static final int LAYOUT_DIALOGPAYMENTDEPOSIT = 136;

  private static final int LAYOUT_DIALOGPAYMENTDEPOSITDONE = 137;

  private static final int LAYOUT_DIALOGPAYMENTDONE = 138;

  private static final int LAYOUT_DIALOGPOSTINGDONE = 139;

  private static final int LAYOUT_DIALOGPROMOCODE = 140;

  private static final int LAYOUT_DIALOGRATEAPP = 141;

  private static final int LAYOUT_DIALOGRATEME = 142;

  private static final int LAYOUT_DIALOGREFUNDPAYMENT = 143;

  private static final int LAYOUT_DIALOGREFUNDREASON = 144;

  private static final int LAYOUT_DIALOGREFUNDUSER = 145;

  private static final int LAYOUT_DIALOGRELEASEPAYMENT = 146;

  private static final int LAYOUT_DIALOGREPOSTDELETEJOB = 147;

  private static final int LAYOUT_DIALOGSECURITYCODE = 148;

  private static final int LAYOUT_DIALOGSORTBYFILTER = 149;

  private static final int LAYOUT_DIALOGSTARS = 150;

  private static final int LAYOUT_DIALOGSTORAGEDISCLOSURE = 151;

  private static final int LAYOUT_DIALOGWITHDRAW = 152;

  private static final int LAYOUT_DIALOGZOOMPORTFOLIOIMAGE = 153;

  private static final int LAYOUT_FRAGMENTABOUTPROFILE = 154;

  private static final int LAYOUT_FRAGMENTALLPOPULARLAWYER = 155;

  private static final int LAYOUT_FRAGMENTATTACHMENT = 156;

  private static final int LAYOUT_FRAGMENTBALANCEDEPOSIT = 157;

  private static final int LAYOUT_FRAGMENTBALANCEHISTORY = 158;

  private static final int LAYOUT_FRAGMENTBALANCEPAYMENT = 159;

  private static final int LAYOUT_FRAGMENTCAMPDETAIL = 160;

  private static final int LAYOUT_FRAGMENTCAMPPAY = 161;

  private static final int LAYOUT_FRAGMENTCAMPSTARS = 162;

  private static final int LAYOUT_FRAGMENTCHATLIST = 163;

  private static final int LAYOUT_FRAGMENTCHATMANAGER = 164;

  private static final int LAYOUT_FRAGMENTCHOOSEDEVELOPER = 165;

  private static final int LAYOUT_FRAGMENTCHOOSESKILLS = 166;

  private static final int LAYOUT_FRAGMENTDEADLINE = 167;

  private static final int LAYOUT_FRAGMENTDEPOSITFUNDS = 168;

  private static final int LAYOUT_FRAGMENTDESCRIBE = 169;

  private static final int LAYOUT_FRAGMENTEARNMONEY = 170;

  private static final int LAYOUT_FRAGMENTENTERRATE = 171;

  private static final int LAYOUT_FRAGMENTINFAGENCY = 172;

  private static final int LAYOUT_FRAGMENTINFALL = 173;

  private static final int LAYOUT_FRAGMENTINFSERVICES = 174;

  private static final int LAYOUT_FRAGMENTLAWYERSERVICE = 175;

  private static final int LAYOUT_FRAGMENTLIVECHAT = 176;

  private static final int LAYOUT_FRAGMENTMYLEVEL = 177;

  private static final int LAYOUT_FRAGMENTPAYTYPE = 178;

  private static final int LAYOUT_FRAGMENTPOSTJOB = 179;

  private static final int LAYOUT_FRAGMENTPROJECTDETAILS = 180;

  private static final int LAYOUT_FRAGMENTPROJECTPAYMENTNEW = 181;

  private static final int LAYOUT_FRAGMENTPROJECTRATE = 182;

  private static final int LAYOUT_FRAGMENTPROJECTSTATUS = 183;

  private static final int LAYOUT_FRAGMENTPROJECTSUBMIT = 184;

  private static final int LAYOUT_FRAGMENTPROJECTSLIST = 185;

  private static final int LAYOUT_FRAGMENTREVIEWSPROFILE = 186;

  private static final int LAYOUT_FRAGMENTSELECTRATE = 187;

  private static final int LAYOUT_FRAGMENTSELECTSERVICE = 188;

  private static final int LAYOUT_FRAGMENTSKILLPROFILE = 189;

  private static final int LAYOUT_FRAGMENTWANTTOPAY = 190;

  private static final int LAYOUT_FRAGMENTWIN = 191;

  private static final int LAYOUT_HIREGRIDITEM = 192;

  private static final int LAYOUT_HOMEGRIDITEM = 193;

  private static final int LAYOUT_HOMELISTITEM = 194;

  private static final int LAYOUT_HOMEPAGEITEM = 195;

  private static final int LAYOUT_ITEMACCOUNT = 196;

  private static final int LAYOUT_ITEMBANNERLAWYER = 197;

  private static final int LAYOUT_ITEMCAMPAIGNINPROGRESS = 198;

  private static final int LAYOUT_ITEMCAMPAIGNSTARS = 199;

  private static final int LAYOUT_ITEMCARDLIST = 200;

  private static final int LAYOUT_ITEMCARDVIEW = 201;

  private static final int LAYOUT_ITEMCATEGORYLIST = 202;

  private static final int LAYOUT_ITEMCHATLIST = 203;

  private static final int LAYOUT_ITEMCHATMESSAGES = 204;

  private static final int LAYOUT_ITEMCHATMSG = 205;

  private static final int LAYOUT_ITEMCHIPVIEW = 206;

  private static final int LAYOUT_ITEMCHOOSEACCOUNT = 207;

  private static final int LAYOUT_ITEMCLIENTREVIEW = 208;

  private static final int LAYOUT_ITEMCUSTOMGIGDETAILS = 209;

  private static final int LAYOUT_ITEMCUSTOMGIGPROJECTDETAILS = 210;

  private static final int LAYOUT_ITEMCUSTOMPRICE = 211;

  private static final int LAYOUT_ITEMEXPERTLIST = 212;

  private static final int LAYOUT_ITEMEXPERTLISTPLACEHOLDER = 213;

  private static final int LAYOUT_ITEMFILESDESC = 214;

  private static final int LAYOUT_ITEMFILTERSERVICE = 215;

  private static final int LAYOUT_ITEMFOLLWERSLIST = 216;

  private static final int LAYOUT_ITEMGIGDETAILPAGER = 217;

  private static final int LAYOUT_ITEMGIGDETAILS = 218;

  private static final int LAYOUT_ITEMGIGDETAILSPLACEHOLDER = 219;

  private static final int LAYOUT_ITEMGIGEXTRAS = 220;

  private static final int LAYOUT_ITEMGIGHOME = 221;

  private static final int LAYOUT_ITEMGIGHOMENEW = 222;

  private static final int LAYOUT_ITEMGIGPLACEHOLDER = 223;

  private static final int LAYOUT_ITEMHIRE = 224;

  private static final int LAYOUT_ITEMHOME = 225;

  private static final int LAYOUT_ITEMHOMECATEGORY = 226;

  private static final int LAYOUT_ITEMHOMECATEGORYLAWYER = 227;

  private static final int LAYOUT_ITEMHOMEFOLLOWER = 228;

  private static final int LAYOUT_ITEMHOMEISTOP = 229;

  private static final int LAYOUT_ITEMINCOMEBALANE = 230;

  private static final int LAYOUT_ITEMINFREVIEWS = 231;

  private static final int LAYOUT_ITEMINFSERVICE = 232;

  private static final int LAYOUT_ITEMINFSERVICENEW = 233;

  private static final int LAYOUT_ITEMINFSERVICES = 234;

  private static final int LAYOUT_ITEMINFSTORE = 235;

  private static final int LAYOUT_ITEMJOBTITLE = 236;

  private static final int LAYOUT_ITEMLANGUAGEAGENTS = 237;

  private static final int LAYOUT_ITEMLISTFILES = 238;

  private static final int LAYOUT_ITEMLISTFILESSURVEY = 239;

  private static final int LAYOUT_ITEMMYINVOICE = 240;

  private static final int LAYOUT_ITEMMYSTORE = 241;

  private static final int LAYOUT_ITEMNOTIFICATION = 242;

  private static final int LAYOUT_ITEMNOTIFICATIONPH = 243;

  private static final int LAYOUT_ITEMPARTNERANSWER = 244;

  private static final int LAYOUT_ITEMPARTNERS = 245;

  private static final int LAYOUT_ITEMPLATFORM = 246;

  private static final int LAYOUT_ITEMPLATFORMIMG = 247;

  private static final int LAYOUT_ITEMPLATFORMSELECTION = 248;

  private static final int LAYOUT_ITEMPOLICY = 249;

  private static final int LAYOUT_ITEMPOPULAR = 250;

  private static final int LAYOUT_ITEMPOPULARPLACEHOLDER = 251;

  private static final int LAYOUT_ITEMPORTFOLIOLIST = 252;

  private static final int LAYOUT_ITEMPORTFOLIOLISTPH = 253;

  private static final int LAYOUT_ITEMPORTFOLIOSMALL = 254;

  private static final int LAYOUT_ITEMPROJECTSLIST = 255;

  private static final int LAYOUT_ITEMPROPOSALFREELANCERLIST = 256;

  private static final int LAYOUT_ITEMPROPOSALLIST = 257;

  private static final int LAYOUT_ITEMREFERRALHISTORY = 258;

  private static final int LAYOUT_ITEMREVIEWS = 259;

  private static final int LAYOUT_ITEMREVIEWSPH = 260;

  private static final int LAYOUT_ITEMSELECTFULL = 261;

  private static final int LAYOUT_ITEMSELECTLANGUAGE = 262;

  private static final int LAYOUT_ITEMSELECTRATE = 263;

  private static final int LAYOUT_ITEMSELECTSERVICE = 264;

  private static final int LAYOUT_ITEMSELECTEDSTARS = 265;

  private static final int LAYOUT_ITEMSERVICESELLERS = 266;

  private static final int LAYOUT_ITEMSINGLEMULTISELECTION = 267;

  private static final int LAYOUT_ITEMSKILLFILTER = 268;

  private static final int LAYOUT_ITEMSKILLS = 269;

  private static final int LAYOUT_ITEMSKILLSEDIT = 270;

  private static final int LAYOUT_ITEMSKILLSPOST = 271;

  private static final int LAYOUT_ITEMSM = 272;

  private static final int LAYOUT_ITEMSOCIAL = 273;

  private static final int LAYOUT_ITEMSOCIALGIG = 274;

  private static final int LAYOUT_ITEMSOCIALGIGDETAILS = 275;

  private static final int LAYOUT_ITEMSOCIALINFSERV = 276;

  private static final int LAYOUT_ITEMSOCIALMEDIA = 277;

  private static final int LAYOUT_ITEMSOCIALMEDIAPROFILE = 278;

  private static final int LAYOUT_ITEMSOCIALSERVICE = 279;

  private static final int LAYOUT_ITEMSTARS = 280;

  private static final int LAYOUT_ITEMSTARSPLATFORM = 281;

  private static final int LAYOUT_ITEMSUBMITTEDFILES = 282;

  private static final int LAYOUT_ITEMUPLOADEDFILES = 283;

  private static final int LAYOUT_ITEMUSERREHIRE = 284;

  private static final int LAYOUT_ITEMVERIFICATION = 285;

  private static final int LAYOUT_ITEMVERIFIEDWITH = 286;

  private static final int LAYOUT_ITEMVIEWALLCATEGORY = 287;

  private static final int LAYOUT_ITEMWALLET = 288;

  private static final int LAYOUT_ITEMWORKWITH = 289;

  private static final int LAYOUT_ITEMYOUTUBEPROFILE = 290;

  private static final int LAYOUT_LAYIMAGE = 291;

  private static final int LAYOUT_LAYTEXT = 292;

  private static final int LAYOUT_LAYOUTHOMEHOWWORK = 293;

  private static final int LAYOUT_LAYOUTMILESTONEPAYMENT = 294;

  private static final int LAYOUT_LAYOUTTEXTVIEW = 295;

  private static final int LAYOUT_NODATALAYOUT = 296;

  private static final int LAYOUT_TIMELINEITEM = 297;

  private static final int LAYOUT_TOOLBARBACK = 298;

  private static final int LAYOUT_TOOLBARO = 299;

  private static final int LAYOUT_TOOLBARPROGRESSNEXT = 300;

  private static final int LAYOUT_TOOLBARSAVE = 301;

  private static final int LAYOUT_TOOLBARTITLE = 302;

  private static final int LAYOUT_VIEWAGENCY = 303;

  private static final int LAYOUT_VIEWMYSTORE = 304;

  private static final int LAYOUT_VIEWOVERVIEW = 305;

  private static final int LAYOUT_VIEWPARTNER = 306;

  private static final int LAYOUT_VIEWPORTFOLIO = 307;

  private static final int LAYOUT_VIEWSERVICES = 308;

  private static final int LAYOUT_VIEWSOCIALMEDIA = 309;

  private static final int LAYOUT_VIEWWORKWITH = 310;

  private static final int LAYOUT_VIEWYOUTUBE = 311;

  private static final int LAYOUT_VWLAYOUTITEMAUDIOPICK = 312;

  private static final int LAYOUT_VWLAYOUTITEMFOLDERLIST = 313;

  private static final SparseIntArray INTERNAL_LAYOUT_ID_LOOKUP = new SparseIntArray(313);
  ...
  private static class InnerLayoutIdLookup {
    static final HashMap<String, Integer> sKeys = new HashMap<String, Integer>(313);
