...
public class ItemMyInvoiceBindingImpl extends ItemMyInvoiceBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.tv_campId, 3);
    ...
    public ItemMyInvoiceBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 8, sIncludes, sViewsWithIds));
    }
    private ItemMyInvoiceBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
