...
package com.nojom.client.chipview;
...
public abstract class ChipViewAdapter extends Observable {
    ...
    private List<ExpertLawyers.Skills> mChipList;
    ...
    private void init() {
        mChipSpacing = (int) mContext.getResources().getDimension(R.dimen._5sdp);
        mLineSpacing = (int) mContext.getResources().getDimension(R.dimen._5sdp);
        mChipPadding = (int) mContext.getResources().getDimension(R.dimen._5sdp);
        mChipSidePadding = (int) mContext.getResources().getDimension(R.dimen._10sdp);
        mChipCornerRadius = (int) mContext.getResources().getDimension(R.dimen._15sdp);
        mChipBackgroundColor = getColor(R.color.athens_gray);
    ...
    public View getView(ViewGroup parent, int position) {
        View view = null;
        ExpertLawyers.Skills chip = getChip(position);
    ...
    private Drawable generateBackgroundSelector(int position) {
        ...
        int borderColor = mContext.getResources().getColor(R.color.athens_gray);
        // Default state
    ...
    public ExpertLawyers.Skills getChip(int position) {
     ...
     * @param chip
     */
    public void add(ExpertLawyers.Skills chip) {
     ...
     * @param chip
     */
    public void remove(ExpertLawyers.Skills chip) {
     ...
     */
    public int count() {
        return Math.min(mChipList.size(), 8);
    }
    ...
    public List<ExpertLawyers.Skills> getChipList() {
        return mChipList;
    }

    public void setChipList(List<ExpertLawyers.Skills> chipList) {
        mChipList = chipList;
        notifyUpdate();
    }
