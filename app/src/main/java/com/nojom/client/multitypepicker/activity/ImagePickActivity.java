...
import com.nojom.client.multitypepicker.DividerGridItemDecoration;
import com.nojom.client.multitypepicker.adapter.ImagePickAdapter;
...
public class ImagePickActivity extends BaseActivity {
    ...
    private String os10CaptureImage = "";
    ...
    private void initView() {
        ...
        tv_count.setText(String.format(Locale.US,"%d/%d", mCurrentNumber, mMaxNumber));
            ...
            switch (requestCode) {
                ...
                case Constant.REQUEST_CODE_BROWSER_IMAGE:
                    if (resultCode == RESULT_OK) {
                        ...
                        mCurrentNumber = Objects.requireNonNull(list).size();
    ...
    private void loadData() {
        FileFilter.getImages(ImagePickActivity.this, directories -> {
            // Refresh folder list
            if (isNeedFolderList) {
    ...
    private void refreshData(List<Directory<ImageFile>> directories) {
        ...
        if (TextUtils.isEmpty(os10CaptureImage)) {//regular case less than os 10
        ...
        } else {//Code is set for OS 10 Device [After capture image]
            tryToFindTakenImage = true;
        }
