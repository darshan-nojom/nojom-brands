...
public class ProjectGigStatusFragmentVM extends AndroidViewModel implements View.OnClickListener, RequestResponseListener,
    ...
    ProjectGigStatusFragmentVM(Application application, FragmentProjectStatusBinding fragmentProjectStatusBinding, BaseFragment projectStatusFragment) {
        super(application);
        ...
        if (projectData != null) {
            ...
            switch (projectData.gigStateID) {
                case Constants.WAITING_FOR_AGENT_ACCEPTANCE:
                    ...
                    binding.tvCancelFreelancer.setVisibility(View.GONE);
                ...
                case Constants.SUBMIT_WAITING_FOR_PAYMENT:
                    ...
                    ClickableSpan balanceClick = new ClickableSpan() {
                        ...
                        public void onClick(@NotNull View view) {
                            ((ProjectGigDetailsActivity) fragment.activity).setPagerPosition(3);
                        }
                ...
                case Constants.COMPLETED:
                    ...
                    String[] words = {fragment.getString(R.string.job_is_closed_now)};
            ...
            if (projectData.agentDetails != null) {
                ...
                fragment.activity.setImage(binding.proposal.imgUser, TextUtils.isEmpty(projectData.agentDetails.photo) ? "" : profileData.filePath.pathProfilePicAgent + projectData.agentDetails.photo, 0, 0);
                fragment.activity.setImage(binding.rehire.imgUser3, TextUtils.isEmpty(projectData.agentDetails.photo) ? "" : profileData.filePath.pathProfilePicAgent + projectData.agentDetails.photo, 0, 0);
                fragment.activity.setImage(binding.imgUser1, TextUtils.isEmpty(projectData.agentDetails.photo) ? "" : profileData.filePath.pathProfilePicAgent + projectData.agentDetails.photo, 0, 0);
                ...
                binding.tvPlace1.setText(String.format(Locale.US, fragment.activity.getCurrency().equals("SAR") ? fragment.getString(R.string.s_sar) : "$%s", projectData.totalPrice));
                binding.proposal.tvBidPrice.setText(fragment.activity.getCurrency().equals("SAR") ? Utils.decimalFormat(String.valueOf(projectData.totalPrice)) + " " + fragment.getString(R.string.sar)
                        : "$" + Utils.decimalFormat(String.valueOf(projectData.totalPrice)));
    ...
    private void setTimerTextForIncrement() {
        ...
        if (projectData.timer.days != null) {
            ...
            case R.id.tv_chat3:
                if (profileData != null && projectData.agentDetails != null) {
                    ...
                    if (fragment.activity.getIsVerified() == 1) {
                        ...
                        fragment.activity.toastMessage(fragment.activity.getString(R.string.verification_is_pending_please_complete_the_verification_first_before_chatting_with_them));
                    }
                }
                break;
        }
    ...
    private void cancelFreelancerDialog() {
        ...
        String[] words = {fragment.activity.getString(R.string.free).toUpperCase()};
        String[] fonts = {Constants.SFTEXT_BOLD};
    ...
    public void successResponse(String responseBody, String url, String message, String data) {
        if (url.equalsIgnoreCase(API_CANCEL_CONTRACT)) {
...
//                Intent i = new Intent(fragment.activity, FreelancerProfileActivity.class);
                ...
                if (viewProfile) {
                    if (projectData.gigStateID == (Constants.CANCELLED) ||
                            projectData.gigStateID == (Constants.COMPLETED) ||
                            projectData.gigStateID == (Constants.REFUNDED)) {
