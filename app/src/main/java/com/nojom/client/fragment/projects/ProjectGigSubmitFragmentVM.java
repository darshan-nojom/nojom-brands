...
class ProjectGigSubmitFragmentVM extends AndroidViewModel implements RecyclerviewAdapter.OnViewBindListner {
    ...
    ProjectGigSubmitFragmentVM(Application application, FragmentProjectSubmitBinding projectSubmitBinding, BaseFragment projectSubmitFragment) {
        super(application);
    ...
    private void setAdapter() {
        if (filesList != null && filesList.size() > 0) {
            ...
            if (fileAdapter == null) {
                fileAdapter = new SubmitFilesAdapter(fragment.activity, (ArrayList<FileList>) filesList,projectData.agentSubmittedPath);
