...
import com.nojom.client.databinding.ItemYoutubeProfileBinding;
...
//    }
    ...
    public void onBindViewHolder(final SimpleViewHolder holder, final int position) {
        ...
        Glide.with(context).load(videothumb).placeholder(R.drawable.dp).diskCacheStrategy(DiskCacheStrategy.ALL).listener(new RequestListener<Drawable>() {
            @Override
...
//                    binding.progressBar.setVisibility(View.GONE);
    ...
    private class FetchVideoTitleTask extends AsyncTask<String, Void, String> {
        ...
        public FetchVideoTitleTask(CustomTextView txtName) {
