...
public class SelectCountryAdapter extends RecyclerView.Adapter<SelectCountryAdapter.SimpleViewHolder>
    ...
    public SelectCountryAdapter(Context context, List<CCPCountry> objects) {
