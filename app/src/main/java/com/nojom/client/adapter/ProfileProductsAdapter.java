...
import com.nojom.client.databinding.ItemProfileProductBinding;
...
public class ProfileProductsAdapter extends RecyclerView.Adapter<ProfileProductsAdapter.SimpleViewHolder> {
    ...
    public String path;
    private List<GetStores.Data> paymentList;
//    private OnClickListener onClickListener;

    public GetStores.Data getData(int pos) {
...
//        this.onClickPlatformListener = updatelistener;
    ...
    public void doRefresh(List<GetStores.Data> paymentList) {
    ...
    public void onBindViewHolder(final SimpleViewHolder holder, final int position) {
        GetStores.Data item = paymentList.get(position);
...
//                context.setArFont(binding.txtPrice, Constants.FONT_AR_REGULAR);
    ...
    public interface OnClickListener {
        void onClickShowProduct(GetStores.Data companies, int pos);

        void onClickMenuProduct(GetStores.Data companies, int pos, View view, int loc);
    }
