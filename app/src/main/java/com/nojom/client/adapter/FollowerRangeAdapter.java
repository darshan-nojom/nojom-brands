...
public class FollowerRangeAdapter extends RecyclerView.Adapter<FollowerRangeAdapter.SimpleViewHolder> {
    ...
    public FollowerRangeAdapter(Context context, List<PriceRange> cardList, OnClickCategoryListener listener) {
    ...
    public interface OnClickCategoryListener {
        void onClickFollower(boolean isAdded, PriceRange data, int adapterPos);
    }
...
//                    clearSelected();
                    ...
                    if (onClickCategoryListener != null) {
                        onClickCategoryListener.onClickFollower(serviceCatgList.get(getAbsoluteAdapterPosition()).isSelected, serviceCatgList.get(getAbsoluteAdapterPosition()), getAbsoluteAdapterPosition());
                    }
