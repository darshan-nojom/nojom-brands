...
public class SelectPartnerAgeAdapter extends RecyclerView.Adapter<SelectPartnerAgeAdapter.SimpleViewHolder>
    ...
    public SelectPartnerAgeAdapter(BaseActivity context, ArrayList<PartnerWithUsResponse.Answers> objects) {
    ...
    public void onBindViewHolder(@NonNull final SimpleViewHolder holder, final int position) {
        try {
            ...
            holder.binding.tvTitle.setText(item.getAnswer(context.getLanguage()));
            ...
            protected FilterResults performFiltering(CharSequence charSequence) {
                ...
                if (charString.isEmpty()) {
                    ...
                    for (PartnerWithUsResponse.Answers row : mDataset) {
                        String rowText = row.getAnswer(context.getLanguage()).toLowerCase();
