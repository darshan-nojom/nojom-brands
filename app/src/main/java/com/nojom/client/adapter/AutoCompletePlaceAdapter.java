...
public class AutoCompletePlaceAdapter extends ArrayAdapter<AutocompletePrediction> implements Filterable {

    private List<AutocompletePrediction> mResultList;
    private PlacesClient placesClient;

    public AutoCompletePlaceAdapter(Context context, PlacesClient placesClient) {
    ...
    private List<AutocompletePrediction> getAutocomplete(CharSequence constraint) {
        ...
        final FindAutocompletePredictionsRequest.Builder requestBuilder =
                FindAutocompletePredictionsRequest.builder()
                        ...
                        .setLocationBias(RectangularBounds.newInstance(new LatLng(0.0d, 0.0d), new LatLng(0.0d, 0.0d)))
