...
public class AgeAdapter extends RecyclerView.Adapter<AgeAdapter.SimpleViewHolder> {
    ...
    public AgeAdapter(Context context, List<PriceRange> cardList, OnClickCategoryListener listener) {
    ...
    public interface OnClickCategoryListener {
        void onClickAge(boolean isAdded, PriceRange data, int adapterPos);
    }
...
//                    clearSelected();
                    ...
                    if (onClickCategoryListener != null) {
                        onClickCategoryListener.onClickAge(serviceCatgList.get(getAbsoluteAdapterPosition()).isSelected, serviceCatgList.get(getAbsoluteAdapterPosition()), getAbsoluteAdapterPosition());
                    }
