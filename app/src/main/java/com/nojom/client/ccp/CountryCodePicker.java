...
public class CountryCodePicker extends RelativeLayout {
    ...
    OnClickListener countryCodeHolderClickListener = v -> {
        if (isCcpClickable()) {
    ...
    private void init(AttributeSet attrs) {
        ...
        if (xmlWidth != null && (xmlWidth.equals(LayoutParams.MATCH_PARENT + "") || xmlWidth.equals("fill_parent") || xmlWidth.equals("match_parent"))) {
        ...
        try {
            ...
            if (defaultCountryNameCode != null && defaultCountryNameCode.length() != 0) {
                if (!isInEditMode()) {
                    ...
                    if (CCPCountry.getCountryForNameCodeFromEnglishList(defaultCountryNameCode,context) != null) {
                        setUsingNameCode = true;
                        setDefaultCountry(CCPCountry.getCountryForNameCodeFromEnglishList(defaultCountryNameCode,context));
                        setSelectedCountry(defaultCCPCountry);
                    }
                }
                ...
                if (!setUsingNameCode) {
                    setDefaultCountry(CCPCountry.getCountryForNameCodeFromEnglishList("sa",context));
                    setSelectedCountry(defaultCCPCountry);
                    setUsingNameCode = true;
                }
            }
            ...
            if (!setUsingNameCode && defaultCountryCode != -1) {
                if (!isInEditMode()) {
                    ...
                    CCPCountry defaultCountry = CCPCountry.getCountryForCodeFromEnglishList(defaultCountryCode + "",context);
                    if (defaultCountry == null) {
                        defaultCountry = CCPCountry.getCountryForCodeFromEnglishList(LIB_DEFAULT_COUNTRY_CODE + "",context);
                    }
...
//            }
    ...
    public OnClickListener getCountryCodeHolderClickListener() {
    ...
    public String getDefaultCountryNameEn() {
        return getDefaultCountry().englishName;
    }
    ...
    public boolean isValidFullNumber() {
        try {
            if (getEditText_registeredCarrierNumber() != null && getEditText_registeredCarrierNumber().getText().length() != 0) {
                ...
                Utils.toastMessage(context,"No editText for Carrier number found.");
                return false;
            } else {
                return false;
            }
