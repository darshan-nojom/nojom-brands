...
public class CCPCountryGroup {
    ...
    static CCPCountryGroup getCountryGroupForPhoneCode(int countryCode) {
     ...
     */
    CCPCountry getCountryForAreaCode(Context context, CountryCodePicker.Language language, String areaCode) {
