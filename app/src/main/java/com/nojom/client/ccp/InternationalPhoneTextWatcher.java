...
public class InternationalPhoneTextWatcher implements TextWatcher {
     ...
     */
    InternationalPhoneTextWatcher(Context context, String countryNameCode, int countryPhoneCode) {
    ...
    private void updateCountry(String countryNameCode, int countryPhoneCode) {
