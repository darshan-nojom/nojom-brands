...
public class WebViewActivity extends BaseActivity {
    ...
    private String paymentUrl, intentData, campId;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        User user = new User(getUserName(), getUserID(), campId);
        Log.e("data--", "intent " + intentData + " " + user.id + " " + campId);
            ...
            if (map != null) {
                ...
                if (hm != null) {
                    try {
                        ...
                        if (campId.equals(cId) && status != null) {
                            switch (status) {
                                case "success":
                                    postDoneDialog(true);
                                    break;
