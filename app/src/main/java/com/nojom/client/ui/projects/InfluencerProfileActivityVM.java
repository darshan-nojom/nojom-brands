...
import com.nojom.client.fragment.profile.InfAgencyFragment;
import com.nojom.client.fragment.profile.InfAllFragment;
import com.nojom.client.fragment.profile.InfServicesFragment;
...
class InfluencerProfileActivityVM extends AndroidViewModel implements View.OnClickListener, RequestResponseListener, BaseActivity.ExpertInfoListener {
    ...
    public void setServiceList(List<SocialPlatformList.Data> socialPlatformList) {
        ...
        if (infServicesFragment != null) {
            infServicesFragment.setList();
        }
    }
...
//            ArrayList<ProfilePlatform> profilePlatformArrayList = new ArrayList<>();
//            profilePlatformArrayList.add(new ProfilePlatform(activity.getString(R.string.facebook), activity.getResources().getDrawable(R.drawable.facebook)));
//            profilePlatformArrayList.add(new ProfilePlatform(activity.getString(R.string.facebook), activity.getResources().getDrawable(R.drawable.facebook)));
//            profilePlatformArrayList.add(new ProfilePlatform(activity.getString(R.string.facebook), activity.getResources().getDrawable(R.drawable.facebook)));
//            profilePlatformArrayList.add(new ProfilePlatform(activity.getString(R.string.facebook), activity.getResources().getDrawable(R.drawable.facebook)));
//            profilePlatformArrayList.add(new ProfilePlatform(activity.getString(R.string.facebook), activity.getResources().getDrawable(R.drawable.facebook)));
//            profilePlatformArrayList.add(new ProfilePlatform(activity.getString(R.string.facebook), activity.getResources().getDrawable(R.drawable.facebook)));
//            setPlatformAdapter(profilePlatformArrayList);
...
//        }
    ...
    public void setTabSelection(int tab) {
        binding.segmentGroup.setPosition(tab, false);
    }
    ...
    InfServicesFragment infServicesFragment;

    private void setupViewPager(ViewPager viewPager) {
        ViewPagerAdapter adapter = new ViewPagerAdapter(activity.getSupportFragmentManager());
        adapter.addFrag(new InfAllFragment(), activity.getString(R.string.all_1));
        adapter.addFrag(infServicesFragment = new InfServicesFragment(), activity.getString(R.string.services));
        adapter.addFrag(new InfAgencyFragment(), activity.getString(R.string.agency));
