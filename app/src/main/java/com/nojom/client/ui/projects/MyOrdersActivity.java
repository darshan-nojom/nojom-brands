...
import com.nojom.client.adapter.OrderAdapter;
import com.nojom.client.adapter.PastOrderAdapter;
import com.nojom.client.databinding.ActivityMyOrdersBinding;
...
public class MyOrdersActivity extends BaseActivity implements View.OnClickListener,
        OrderAdapter.OnClickJobListener, PastOrderAdapter.OnClickJobListener {
