...
class WinFragmentVM extends AndroidViewModel implements View.OnClickListener, RequestResponseListener {
    ...
    void onResumeMethod() {
        if (fragment.activity.getUserData() != null && fragment.activity.getUserData().clientSurvey == 1) {
    ...
    private void initData() {
        ...
        if (fragment.activity.getCurrency().equals("SAR")) {
            binding.tvHereBlue.setText(fragment.getString(R.string.answer_6_questions_and_get_2_plus_get_a_chance_to_win_100_gift_card_sar));
        }
