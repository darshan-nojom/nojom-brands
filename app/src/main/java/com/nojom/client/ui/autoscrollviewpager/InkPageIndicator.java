package com.nojom.client.ui.autoscrollviewpager;
...
public class InkPageIndicator extends View implements ViewPager.OnPageChangeListener,
    ...
    // defaults
    private static final int DEFAULT_DOT_SIZE = 4;                      // dp
    private static final int DEFAULT_GAP = 6;                          // dp
    private static final int DEFAULT_ANIM_DURATION = 1000;               // ms
